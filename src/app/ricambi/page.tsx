...
import { ricambisti } from "@/data/places";
  ...
  return (
    <>
      <div className="text-center pt-0 pb-3 md:hidden">
        <h1 className="text-lg md:text-2xl font-bold text-black tracking-[0.35em]" style={{ fontFamily: "var(--font-body)" }}>RICAMBI</h1>
      </div>
      <section className="relative h-[50vh] md:h-[70vh] overflow-hidden -mx-2 md:max-w-6xl md:mx-auto md:rounded-xl">
        <Image src="/images/RICAMBI.jpg" alt="Ricambi" fill className="object-cover" priority />
      </section>
      <div className="text-center pt-8 pb-4 md:pt-10 md:pb-6">
        <p className="text-sm md:text-lg italic text-black/70" style={{ fontFamily: "var(--font-body)" }}>Autenticità e precisione</p>
        <p className="mt-1 text-xs md:text-sm text-black/60 max-w-xl mx-auto text-center px-4" style={{ fontFamily: "var(--font-body)" }}>Componenti originali e riproduzioni d&apos;eccellenza, organizzati per marca e modello.</p>
      </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-20">
        ...
        <div className="-mx-4 lg:mx-0 mb-6 lg:mb-0 lg:float-left lg:w-2/3 lg:pr-3">
          <div className="h-[400px] lg:h-[500px] lg:rounded-xl overflow-hidden">
            <MapView places={ricambisti} onSelect={handleSelect} selectedPlace={selected} />
          </div>
        </div>
